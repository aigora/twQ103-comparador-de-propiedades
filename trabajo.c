...
switch (opcion){
  case 1  : printf("Introduzca el nombre del elemento, en minusculas y sin tildes si tuviera, para  saber sus propiedades:\n");
	        ...
	        printf("\n-Las superficies de %s recientes son de color blanco plateado pero presenta un cambio fisico rapidamente, cambiando a un color levemente amarillo expuestas al aire y en ultima instancia grises o blancas por la formación de hidroxido al reaccionar con la humedad ambiental.");
		    printf("\n-Propiedades:");
		    printf("\n  Estado ordinario: Solido.");
			printf("\n  Estructura: Cubico centrado en las caras.");
			printf("\n  Densidad: 1550 kg/m3.");
