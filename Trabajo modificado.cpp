...
//Doy a elegir una opcion para ejecutar su respectiva funcion			
do {printf("\n- Selecccione una opccion.\n");
	printf("1-Propiedades de cada elemento\n");
	printf("2-Comparador de elementos por su grupos periodico\n");
	printf("3-Grupos periodicos\n");
	printf("0-Salir del programa\n");
	scanf("%d",&opcion);
switch (opcion){  //CON EL SWITCH LLAMO A LA FUNCION ELEGIDA
  case 1: 
  		funcion1();
  		break;
...
void funcion1(){  //PRIMERA FUNCION (SE DEFINEN LAS PROPIEDADES DE CADA ELEMENTO)
	char nombre[15];
	printf("Introduzca el nombre del elemento, en minusculas y sin tildes si tuviera, para  saber sus propiedades:\n");
	         scanf("%s",&nombre);
	        if (strcmp(nombre,"hidrogeno")==0){
	        printf("-Su numero atomico es 1 y su simbolo es H. ");
	        printf("\n-El %s es el elemento mas abundante al constituir el 75 por ciento de la   materia de todo el universo");
		    printf("\n-Propiedades:");
...
void funcion2(){  /*SEGUNDA FUNCION (SE ASIGNA EL NUMERO ATOMICO DE CADA ELEMENTO A SU GRUPO, AL INTRODUCIR EL NUMERO ATOMICO DEL ELEMENTO 1
                   SE DICE SU GRUPO PERIODICO, AL INTRODUCIR EL NUMERO ATOMICO DEL ELEMENTO 2 SE DICE SU GRUPO PERIODICO, PERMITIENDO
				   QUE SE COMPAREN*/
	
	int numatomico,numatomico2;
	char nombre2[15],nombre1[15];
	
	printf("Introduzca el primer elemento y su numero atomico:\n");
	         scanf("%s",&nombre1);
	         scanf("%d",&numatomico);
...
void funcion3()  /*SEGUNDA FUNCION (CADA FICHERO ES UNO DE LOS GRUPOS PERIODICOS MAS IMPORTANTES, HABIENDO QUITADOS LOS GRUPOS DE 
                   LOS METALES DE TRANSICION, AL SELECCIONAR UNA DE LAS OCHO OPCIONES SE ABRE EL FICHERO CORRESPONDIENTE)*/
{
	FILE *f1;
	FILE *f2;
	FILE *f3;
	...
	char elemento1[100],elemento2[100],elemento3[100],elemento4[100],elemento5[100],elemento6[100],elemento7[100],elemento8[100];
	...
	int opcion;
		...
		printf("3 - TERREOS\n");
		printf("4 - CARBONOIDES\n");
		printf("5 - NITROGENOIDES\n");
		printf("6 - CALCOGENOS\n");
		printf("7 - HALOGENOS\n");
		printf("8 - GASES_NOBLES\n");
		printf("Selecciona un grupo para ver sus elementos:\n");
		scanf("%d",&opcion);
		...
		switch (opcion){
			case 1:
					...
					f1=fopen("ALCALINOS.txt","r");
					fgets(elemento1, 100, f1);
					printf("%s",elemento1);
					fclose(f1);
			        break;
			case 2:
				
					f2=fopen("ALCALINOTERREOS.txt","r");
					fgets(elemento2, 100, f2);
					printf("%s",elemento2);
					fclose(f2);
					break;
			case 3:
				
					f3=fopen("TERREOS.txt","r");
					fgets(elemento3, 100, f3);
					printf("%s",elemento3);
					fclose(f3);
					break;
			case 4:
				
					f4=fopen("CARBONOIDES.txt","r");
					fgets(elemento4, 100, f4);
					printf("%s",elemento4);
					fclose(f4);
					break;
			case 5:
				
					f5=fopen("NITROGENOIDES.txt","r");
					fgets(elemento5, 100, f5);
					printf("%s",elemento5);
					fclose(f5);
					break;
			case 6:
				
					f6=fopen("CALCOGENOS.txt","r");
					fgets(elemento6, 100, f6);
					printf("%s",elemento6);
					fclose(f6);
					break;
			...
			case 7:
					...
					f7=fopen("HALOGENOS.txt","r");
					fgets(elemento7, 100, f7);
					printf("%s",elemento7);
					fclose(f7);
					break;
			case 8:
				
					f8=fopen("GASES_NOBLES.txt","r");
					fgets(elemento8, 100, f8);
					printf("%s",elemento8);
					fclose(f8);
					break;
